        ...
        <div class="col-md-12">
            ...
            <form method="post">
                <div class="form-group">
                    <label for="ID_Cliente">Identificacion</label>
                    <input type="text" name="ID_Cliente" placeholder="Digita la identificacion" class="form-control" /><br />
                </div>
                <br>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="contraseña" placeholder="Digita la contraseña" class="form-control" /><br />
                </div>
                <br>
                <div class="form-group">
                    <input type="submit" name="submit" value="Crear usuario" class="btn btn-danger" />
                </div>
                <br>
            </form>
        </div>
